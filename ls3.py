...
class LazyFramework:
    ...
    def scan_modules(self):
        ...
        for folder, prefix in ((MODULE_DIR, "modules"),):
            for p in folder.rglob("*"):
                if p.is_dir():
                    continue
                # 2. Abaikan file __init__.py karena itu bukan modul yang bisa di-use.
    ...
    def _read_meta(self, path):
        data = {"description": "(No description available)", "options": []}
        try:
    ...
    def cmd_options(self, args):
        ...
        if hasattr(self.loaded_module.module, "OPTIONS"):
            ...
            # Menampilkan tabel dalam panel dengan border sederhana
