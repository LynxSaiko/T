...
class NetworkScanner:
    ...
    ROUTER_BRANDS = {
        ...
        "Huawei": {
            ...
            "favicon_hashes": [],
            "min_score": 3  # Naikkan threshold untuk hindari false positive
        },
        "ZTE": {
    ...
    def get_service_fingerprint(self, ip, port):
        if port in {21, 22, 23, 25, 110, 143, 8291}:
            try:
                ...
                sock.close()
                return {"type": "L4", "banner": banner[:200]}
            except:
                return {"type": "L4", "banner": ""}

        elif port in {80, 443, 7547, 8080, 8443}:
            scheme = "https" if port in {443, 8443} else "http"
            http_data = {"type": "HTTP", "banner": "", "title": "", "auth_header": "", "status_code": None, "body_samples": [], "favicon_hash": ""}
    ...
    def detect_router_brand(self, open_ports):
        ...
        # Prioritaskan ISP brands (khususnya MyRepublic)
    ...
    def _get_hostname(self, ip):
        try:
            ...
            print(f"Debug: Hostname {ip} - {hostname}")  # Debug
            return hostname
        except:
            print(f"Debug: Hostname {ip} - Tidak ditemukan")  # Debug
            return ""
    ...
    def display_results(self):
        ...
        hosts_table.add_column("Hostname", style="white", width=20, overflow="fold")
