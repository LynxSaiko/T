...
class NetworkScanner:
    ...
    r"HW Version[:\s]*([^\s<]+)",
    r"Rom-0|ROM-0|rom-0",  # presence might imply firmware stored, no version captured
    ...
    def get_service_fingerprint(self, ip, port):
        if port in {21, 22, 23, 25, 110, 143, 8291}:
            ...
            http_data = {"type": "HTTP", "banner": "", "title": "", "auth_header": "", "status_code": None, "body_samples": [], "favicon_hash": "", "firmware": ""}
